---
name: archivist
description: Draft snapshot custody, provenance records, and append-only revision history in the artificial-organisation workflow. Use when a draft must be preserved before fact-check, critic review, or acceptance.
---
